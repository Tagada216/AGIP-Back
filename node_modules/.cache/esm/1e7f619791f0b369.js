let queries,chalk;_91f‍.x([["getIncidents",()=>getIncidents],["getIncident",()=>getIncident],["getReference",()=>getReference],["getIncPrio",()=>getIncPrio],["getIncStatut",()=>getIncStatut],["getIncRespEntity",()=>getIncRespEntity],["getIncImpactLayer",()=>getIncImpactLayer],["getIncRootCause",()=>getIncRootCause],["getChangements",()=>getChangements],["getEnseignes",()=>getEnseignes],["getMainCourante",()=>getMainCourante],["getFormatedMainCourante",()=>getFormatedMainCourante],["getApp",()=>getApp],["getProbs",()=>getProbs],["getCosipProbs",()=>getCosipProbs],["insertMainCourante",()=>insertMainCourante],["insertImpactEnseigne",()=>insertImpactEnseigne],["deleteIncident",()=>deleteIncident],["updateMainCourante",()=>updateMainCourante],["createAgence",()=>createAgence],["updateAgence",()=>updateAgence],["statOrigineIncidentsMajeurs",()=>statOrigineIncidentsMajeurs]]);_91f‍.w("./requetes.js",[["*",null,function(v){queries=v}]]);_91f‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);


// Petite ligne permettant d'utiliser log() au lieu de console.log
const log = _91f‍.g.console.log
...
////////////////////////////////////////
	...
	sequelize.query(
       ...
       function getIncident(idIncident, res) {
	sequelize.query(
		"select incident.id, incident.description, incident.cause, incident.origine, incident.observations, incident.plan_action, incident_statut.nom as statut, " +
		"incident_priorite.priorite, incident_entite_responsable.nom as entite_responsable , incident_couche_si_impactee.nom as couche_si_impactee, " +
		"incident_cause_racine.nom as cause__racine, incident.nombre_occurence, incident.crise_itim, incident.departement_responsable, " +
...
// }
       ...
       async function insertMainCourante(res, input) {
	log("\n"+chalk.yellow("--- DEBUT DE L'INSERTION ---"))
	// On insert dans la table incident en premier (clés étrangères obligent)
	...
	res.sendStatus(200)
       ...
       async function insertImpactEnseigne(res, input) {
	const insertResult = await sequelize.query(queries.CreationIncidentMainCourante(input))
	...
	await sequelize.query(queries.CreationImpactEnseignesMainCourante(input, idIncident))
       ...
       async function deleteIncident(res, input) {
	...
	res.sendStatus(200)
       ...
       async function updateMainCourante(res, input) {
	...
	*/
	...
	// })
       ...
       async function createAgence(res) {


	log("\n"+chalk.yellow("--- DEBUT DE L'INSERTION ---"))
	
	const createNewIncidentAgence = queries.CreationIncidentAgence(res)
	const idIncident = createNewIncidentAgence[1].lastID
	const createRef = queries.CreationReferencesAgence(res,idIncident)
	const createImpactEnseigne = queries.CreationImpactEnseignesAgence(res,idIncident)

	// Insertion des incidents
	log("\n"+chalk.yellow("Insertion des incidents agence"))
	await sequelize.query(createNewIncidentAgence)
	...
	// res.sendStatus(200)
       ...
       async function updateAgence(res) {
	...
	// res.sendStatus(200)
       ...
       async function statOrigineIncidentsMajeurs(res){
