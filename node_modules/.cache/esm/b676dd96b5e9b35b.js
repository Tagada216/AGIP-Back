_b5e‍.x([["FormatedMainCourante",()=>FormatedMainCourante],["MainCourante",()=>MainCourante],["Applications",()=>Applications],["AllApplications",()=>AllApplications],["AllReferences",()=>AllReferences],["CreationIncident",()=>CreationIncident],["CreationReferences",()=>CreationReferences],["CreationImpactEnseignes",()=>CreationImpactEnseignes],["CreationIncidentMainCourante",()=>CreationIncidentMainCourante],["CreationImpactEnseignesMainCourante",()=>CreationImpactEnseignesMainCourante],["CreationApplicationsImpactees",()=>CreationApplicationsImpactees],["DeleteIncidentApplicationImpactee",()=>DeleteIncidentApplicationImpactee],["DeleteIncidentImpactEnseigne",()=>DeleteIncidentImpactEnseigne],["DeleteIncidentReference",()=>DeleteIncidentReference],["DeleteIncident",()=>DeleteIncident],["CreationIncidentAgence",()=>CreationIncidentAgence],["CreationReferencesAgence",()=>CreationReferencesAgence],["CreationImpactEnseignesAgence",()=>CreationImpactEnseignesAgence],["UpdateIncidentAgence",()=>UpdateIncidentAgence],["UpdateIncidentImpactEnseigneAgence",()=>UpdateIncidentImpactEnseigneAgence],["GetReferences",()=>GetReferences],["DeleteReferences",()=>DeleteReferences],["UpdateImpactEnseignes",()=>UpdateImpactEnseignes],["getProbs",()=>getProbs],["getOrigineIncMaj",()=>getOrigineIncMaj]]);//import { SELECT } from "sequelize/types/lib/query-types";
...
*/
       ...
       function FormatedMainCourante(id) {
	return `
SELECT incident.id, 
...
////////////////////////////////////
       ...
       function CreationIncident(input) {
	return `
...
`
       ...
       function CreationReferences(input, idIncident) {
	return `
...
`
       ...
       function CreationImpactEnseignes(input, idIncident) {
...
`
       ...
       function CreationIncidentMainCourante(input) {
	return `
INSERT INTO incident(
	description, 
	statut_id, 
...
`
       ...
       function CreationImpactEnseignesMainCourante(input, idIncident) {
	const valuesString = input.enseigne_impactee
		.map(
...
*/
       function CreationApplicationsImpactees(application, idIncident){
...
///////////////////////////////////////
       ...
       function DeleteIncidentApplicationImpactee(input)
{
	return `
...
`
       ...
       function DeleteIncidentImpactEnseigne(input)
{
	return `
...
`
       ...
       function DeleteIncidentReference(input){
	return `
...
////////////////////////////////////
       ...
       function CreationIncidentAgence(input) {
	return `
INSERT INTO incident(
	description,
	cause,
...
`
       ...
       function CreationReferencesAgence(input, idIncident) {
	return `
INSERT INTO incident_reference (
	reference, 
	incident_id)
...
`
       ...
       function CreationImpactEnseignesAgence(input, idIncident) {
	return `
INSERT INTO incident_impact_enseigne (
	incident_id,
	enseigne_id,
...
///////////////////////////////////////
       ...
       function UpdateIncidentAgence(input) {
	return `
UPDATE incident
SET
...
`
       ...
       function UpdateIncidentImpactEnseigneAgence(input) {
	return `
...
`
       ...
       function GetReferences(idIncident) {
	return `
...
`
       ...
       function DeleteReferences(input) {
...
`
       ...
       function UpdateImpactEnseignes(input, checkbox, datepicker) {
	return `
UPDATE incident_impact_enseigne
