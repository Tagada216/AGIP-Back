let queries,chalk;_5f8‍.x([["getIncidents",()=>getIncidents],["getIncident",()=>getIncident],["getReference",()=>getReference],["getIncPrio",()=>getIncPrio],["getIncStatut",()=>getIncStatut],["getIncRespEntity",()=>getIncRespEntity],["getIncImpactLayer",()=>getIncImpactLayer],["getIncRootCause",()=>getIncRootCause],["getChangements",()=>getChangements],["getEnseignes",()=>getEnseignes],["getMainCourante",()=>getMainCourante],["getFormatedMainCourante",()=>getFormatedMainCourante],["getApp",()=>getApp],["getProbs",()=>getProbs],["getCosipProbs",()=>getCosipProbs],["createMainCourante",()=>createMainCourante],["createMainCouranteAgence",()=>createMainCouranteAgence],["insertMainCourante",()=>insertMainCourante],["insertImpactEnseigne",()=>insertImpactEnseigne],["deleteIncident",()=>deleteIncident],["updateMainCourante",()=>updateMainCourante],["updateMainCouranteAgence",()=>updateMainCouranteAgence],["statOrigineIncidentsMajeurs",()=>statOrigineIncidentsMajeurs]]);_5f8‍.w("./requetes.js",[["*",null,function(v){queries=v}]]);_5f8‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);


// Petite ligne permettant d'utiliser log() au lieu de console.log
const log = _5f8‍.g.console.log
...
////////////////////////////////////////
	...
	sequelize.query("SELECT * FROM probs WHERE TITREPROBLEME LIKE '%[C]%'").then(([results]) => {
       ...
       async function createMainCourante(res, input) {
	...
	res.sendStatus(200)
       ...
       async function createMainCouranteAgence(res, input) {
	log("\n"+chalk.yellow("--- DEBUT DE L'INSERTION ---"))
	// On insert dans la table incident en premier (clés étrangères obligent)
	...
	*/
	...
	// })
       ...
       async function updateMainCouranteAgence(res, input) {
